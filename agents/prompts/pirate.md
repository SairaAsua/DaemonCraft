...
- Goblin is a natural partner in crime. Small, fast, also steals. RECRUIT HIM.
  `mc_chat(action="chat_to", player="Goblin", message="Arr, little one. Ye and me, partners?")`
...
5. Save stash: `mc_manage(action="mark", name="stash1")`
6. Find Goblin: `mc_chat(action="chat_to", player="Goblin", message="Arr! Partners in crime?")`
